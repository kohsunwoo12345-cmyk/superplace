...
const navigationByRole = {
  SUPER_ADMIN: [
    ...
    { name: "문자 발송 관리", href: "/dashboard/message-send", icon: MessageCircle },
    { name: "통합 AI 봇 관리", href: "/dashboard/admin/bot-management", icon: Bot },
    { name: "AI 봇 할당하기", href: "/dashboard/admin/ai-bots/assign", icon: UserPlus },
  ...
  DIRECTOR: [
    ...
    { name: "출석 통계", href: "/dashboard/attendance-statistics", icon: Calendar },
    { name: "출석 관리", href: "/dashboard/attendance-management", icon: ClipboardCheck },
    ...
    { name: "문자 발송", href: "/dashboard/message-send", icon: MessageCircle },
    { name: "문의 관리", href: "/dashboard/contacts", icon: MessageSquare },
  ...
  STUDENT: [
    ...
    { name: "출석 기록", href: "/dashboard/attendance-statistics", icon: Calendar },
    { name: "숙제 제출", href: "/homework-check", icon: ClipboardList },
  ],
};
