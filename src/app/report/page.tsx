  ...
  return (
    <html lang="ko">
      <head>
        ...
        <title>{report.studentName} 학생 AI 종합 학습 성과 리포트</title>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-14">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="bg-white border border-slate-100 shadow-sm rounded-xl p-6 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-5xl font-extrabold text-slate-800 mt-2">
                      {report.homeworkCompleted}<span className="text-lg font-medium text-slate-400 ml-1">건</span>
                    </p>
            ...
            <div className="mb-14">
              ...
              <div className="bg-gradient-to-br from-indigo-50 via-white to-purple-50 border border-purple-100 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-shrink-0 relative">
                    <div className="w-32 h-32 rounded-full bg-white shadow-xl flex flex-col items-center justify-center border-4 border-purple-50">
                      <span className="text-sm font-bold text-purple-400">TOTAL</span>
                      <span className="text-4xl font-black text-purple-600">{report.aiChatCount}</span>
            ...
            <div>
              ...
              <div className="mt-16 text-center">
                <div className="inline-block">
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-800 tracking-widest mb-1">{report.academyName}</h2>
                  <p className="text-slate-500 font-semibold text-sm">
                    <span className="text-indigo-600">인문학 박사</span> / 원장 {report.directorName} 배상
                  </p>
                </div>
              </div>
            </div>
    ...
    <Suspense fallback={
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-600">리포트를 불러오는 중...</p>
        </div>
      </div>
    }>
      <ReportContent />
