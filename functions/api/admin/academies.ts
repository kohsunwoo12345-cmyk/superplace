      ...
      try {
        ...
        if (subscription) {
          ...
          currentPlan = {
            ...
            usedStudents: subscription.current_students || 0,
            maxTeachers: subscription.max_teachers || -1,
            usedTeachers: 0,
            maxHomeworkChecks: subscription.max_homework_checks || 0,
            usedHomeworkChecks: subscription.current_homework_checks || 0,
            maxAIAnalysis: subscription.max_ai_analysis || 0,
            usedAIAnalysis: subscription.current_ai_analysis || 0,
            maxAIGrading: -1,
            usedAIGrading: 0,
            maxCapabilityAnalysis: -1,
            usedCapabilityAnalysis: 0,
            maxConceptAnalysis: -1,
            usedConceptAnalysis: 0,
            maxSimilarProblems: subscription.max_similar_problems || 0,
            usedSimilarProblems: subscription.current_similar_problems || 0,
            maxLandingPages: subscription.max_landing_pages || 0,
            usedLandingPages: subscription.current_landing_pages || 0,
